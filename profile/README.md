...
BusDK is currently **pre-release** and under active development: interfaces, schemas, and file conventions may still change, and not all modules are feature-complete. The long-term goal is a coherent suite of modules invoked through the `bus` command (see [Releases](https://github.com/busdk/busdk/releases)). Specifications and documentation live at [docs.busdk.com](https://docs.busdk.com). For deeper architectural background, see [the BusDK design document](https://docs.busdk.com/sdd).
...
* [Modules](https://docs.busdk.com/modules/index)
* [Quick Install](https://busdk.com/)
* [Documentation](https://docs.busdk.com)
* [Releases](https://github.com/busdk/busdk/releases)
