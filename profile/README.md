...
BusDK is currently **pre-release** and under active development: interfaces, schemas, and file conventions may still change, and not all modules are feature-complete. The long-term goal is [a suite of focused subcommand binaries invoked through the `bus`](https://github.com/busdk/busdk). Specifications and documentation live in [docs.busdk.com](https://docs.busdk.com).
